    ...
    s({
      ...
      if (t.params.observer) {
        if (t.params.observeParents) {
          var _e38 = y(t.el);
          for (var _t27 = 0; _t27 < _e38.length; _t27 += 1) o(_e38[_t27]);
        }
        o(t.el, {
    ...
    function u() {
      ...
      r.forEach(function (e, r) {
        if ("fraction" === s.type && (e.querySelectorAll(se(s.currentClass)).forEach(function (e) {
          ...
          var _n7 = 1,
            _l8 = 1;
          "horizontal" === _i13 ? _n7 = _r9 : _l8 = _r9, e.querySelectorAll(se(s.progressbarFillClass)).forEach(function (e) {
      ...
      if (l = !1, d = !1, u.push(e), !(u.length < 2)) {
        ...
        if (m.imageEl) {
          var _ref3 = function () {
            ...
            _e49 = _ref4[0],
            _t39 = _ref4[1];
          m.originX = _e49, m.originY = _t39, m.imageEl.style.transitionDuration = "0ms";
        }
        p = !0;
      }
    }
          ...
          if (s < -t.minTranslate()) t.slideTo(t.activeIndex);else if (s > -t.maxTranslate()) t.slides.length < d.length ? t.slideTo(d.length - 1) : t.slideTo(t.slides.length - 1);else {
            if (r.freeMode.momentum) {
              if (c.velocities.length > 1) {
                ...
                t.velocity = _a22 / _i19, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i19 > 150 || l() - _e58.time > 300) && (t.velocity = 0);
              } else t.velocity = 0;
      ...
      updateWrapperSize: function updateWrapperSize(e, s, a) {
        ...
        if (i.virtualSize = (e + r) * t, i.virtualSize = Math.ceil(i.virtualSize / o) - r, i.wrapperEl.style[a("width")] = "".concat(i.virtualSize + r, "px"), n) {
          ...
          for (var _t42 = 0; _t42 < s.length; _t42 += 1) {
            var _a25 = s[_t42];
            l && (_a25 = Math.floor(_a25)), s[_t42] < i.virtualSize + s[0] && _e61.push(_a25);
          }
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _s42 = 0; _s42 < e.length; _s42 += 1) {
          ...
          var _r14 = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(_e62.progress), 0) : 1 + Math.min(Math.max(_e62.progress, -1), 0),
            _n8 = de(0, _e62);
          _n8.style.opacity = _r14, _n8.style.transform = "translate3d(".concat(_a26, "px, ").concat(_i21, "px, 0px)");
        }
      },
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e65 = 0, _t46 = a.length; _e65 < _t46; _e65 += 1) {
          ...
          if (de(0, _t47).style.transform = _b, _t47.style.zIndex = 1 - Math.abs(Math.round(_p6)), r.slideShadows) {
            ...
            _e66 || (_e66 = pe(0, _t47, n ? "left" : "top")), _s46 || (_s46 = pe(0, _t47, n ? "right" : "bottom")), _e66 && (_e66.style.opacity = _p6 > 0 ? _p6 : 0), _s46 && (_s46.style.opacity = -_p6 > 0 ? -_p6 : 0);
          }
        }
      },
      setTransition: function setTransition(e) {
      ...
      setTranslate: function setTranslate() {
        ...
        var _loop = function _loop() {
          ...
          if (h && f.shadow || !h) {
            ...
            if (!_e68 && f.shadow && (_e68 = pe(0, a)), _e68) {
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _l11 = 0; _l11 < e.length; _l11 += 1) {
          ...
          if (a.slideShadows) {
            ...
            _e71 || (_e71 = pe(0, _o9)), _e71 && (_e71.style.opacity = Math.min(Math.max((Math.abs(_c4) - .5) / .5, 0), 1));
          }
          _o9.style.zIndex = -Math.abs(Math.round(_d7)) + e.length;
          de(0, _o9).style.transform = _x2;
        }
      },
      setTransition: function setTransition(e) {
        var s = t.slides.map(function (e) {
